...
?>
      ...
      <div class="card-block text-center">
        ...
        <?=$this->Html->link(__('Ver mas'), ['controller' => 'Dogs', 'action' => 'view', $dog->id], ['class' => 'btn btn-outline btn-primary hidden-xs'])?>
        <?php if ($name): ?>
        <?=$this->Html->link(__('Adoptar'), ['controller' => 'Dogs', 'action' => 'adoptar', $dog->id], ['class' => 'btn btn-outline btn-primary hidden-xs'])?>
        <?php endif?>
      </div>
    </div>
  </div>
