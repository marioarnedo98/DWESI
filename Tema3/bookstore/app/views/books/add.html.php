...
?>
            ...
            <form action="<?= ROOT_URL?>books/add" id="form" method="POST">
			<h1>New Book</h1>
                ...
                <input type="text" name="published_date" class="isbn" placeholder="Insert the Published date">                <button type="submit" value="Add" name="submit">Submit</button>
            </form>
        </div>
